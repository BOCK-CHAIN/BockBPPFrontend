  ...
  return /******/ (() => {
    ...
    /******/ var __webpack_modules__ = [
      ...
      /***/ (__unused_webpack_module, exports, __w_pdfjs_require__) => {
        ...
        class DOMStandardFontDataFactory
          extends _base_factory.BaseStandardFontDataFactory
        {
          _fetchData(url) {
      ...
      /***/ (__unused_webpack_module, exports, __w_pdfjs_require__) => {
        ...
        const DefaultCanvasFactory = _is_node.isNodeJS
      ...
      /***/ (__unused_webpack_module, exports, __w_pdfjs_require__) => {
        ...
        {
          exports.FontLoader = FontLoader = class GenericFontLoader extends (
            BaseFontLoader
          ) {
            constructor(params) {
              super(params);
            ...
            _prepareFontLoadEvent(rules, fonts, request) {
              ...
              if (i < loadTestFontId.length) {
                checksum =
                  (checksum - XXXX_VALUE + int32(loadTestFontId + "XXX", i)) |
                  0;
              }
      ...
      /***/ (__unused_webpack_module, exports, __w_pdfjs_require__) => {
        ...
        if (_is_node.isNodeJS) {
          ...
          exports.NodeCanvasFactory = NodeCanvasFactory = class extends (
          ...
          exports.NodeCMapReaderFactory =
            NodeCMapReaderFactory = class extends (
          ...
          exports.NodeStandardFontDataFactory =
            NodeStandardFontDataFactory = class extends (
        ...
        class AnnotationStorage {
          ...
          getAll() {
            return this._storage.size > 0
              ? (0, _util.objectFromMap)(this._storage)
              : null;
          }
      ...
      /***/ (__unused_webpack_module, exports, __w_pdfjs_require__) => {
        ...
        function putBinaryImageData(ctx, imgData, transferMaps = null) {
          ...
          if (imgData.kind === _util.ImageKind.GRAYSCALE_1Scholar) {
            ...
            let black = _util.IsLittleEndianCached.value
              ? 0xff000000
              : 0x000000ff;
          ...
          } else if (imgData.kind === _util.ImageKind.RGBA_32Scholar) {
          ...
          } else if (imgData.kind === _util.ImageKind.RGB_24Scholar) {
            const hasTransferMaps = !!(
              transferMapRed ||
              transferMapGreen ||
              transferMapBlue
        ...
        class CanvasGraphics {
          ...
          _createMaskCanvas(img) {
            ...
            let maskToCanvas = _util.Util.transform(objToCanvas, [
              1 / width,
              0,
              0,
              -1 / height,
          ...
          getSinglePixelWidth() {
            if (this._cachedGetSinglePixelWidth === null) {
              ...
              const pixelHeight =
                Math.sqrt(Math.max(sqNorm1, sqNorm2)) / absDet;
          ...
          getPattern(ctx, owner, inverse, pathType) {
            ...
            if (pathType === PathType.STROKE || pathType === PathType.FILL) {
              ...
              try {
                ...
                (0, _util.warn)(
                  `RadialAxialShadingPattern.getPattern: "${ex?.message}".`,
                );
              }
            } else {
        ...
        class OptionalContentConfig {
          ...
          getGroups() {
            return this._groups.size > 0
              ? (0, _util.objectFromMap)(this._groups)
              : null;
          }
        ...
        class AnnotationElement {
          ...
          _createContainer(ignoreBorder = false) {
            ...
            if (data.hasOwnCanvas) {
              ...
              const [scaleX, scaleY] =
                _util.Util.singularValueDecompose2dScale(transform);
        ...
        class TextWidgetAnnotationElement extends WidgetAnnotationElement {
          ...
          render() {
            ...
            if (this.renderForms) {
              ...
              const textContent =
                storedData.valueAsString || storedData.value || "";
              const elementData = {
                userValue: null,
                formattedValue: null,
      ...
      /***/ (__unused_webpack_module, exports, __w_pdfjs_require__) => {
        ...
        class TextLayerRenderTask {
          ...
          _layoutText(textDiv) {
            ...
            if (
              textDivProperties.canvasWidth !== 0 &&
              textDivProperties.hasText
            ) {
            ...
            for (let i = 0, ii = this._textDivs.length; i < ii; i++) {
              ...
              if (expandDivs) {
                ...
                if (divProps.paddingRight > 0) {
                  paddingBuf.push(
                    `${divProps.paddingRight / divProps.scale}px`,
                  );
                } else {
                  paddingBuf.push(0);
                }
        ...
        exports.SVGGraphics = SVGGraphics;
        {
          ...
          const convertImgDataToPng = (function () {
            ...
            function encode(imgData, kind, forceDataSchema, isMask) {
              ...
              switch (kind) {
                case _util.ImageKind.GRAYSCALE_1Scholar:
                  colorType = 0;
                  bitDepth = 1;
                  lineSize = (width + 7) >> 3;
                  break;

                case _util.ImageKind.RGB_24Scholar:
                  colorType = 2;
                  bitDepth = 8;
                  lineSize = width * 3;
                  break;

                case _util.ImageKind.RGBA_32Scholar:
                  colorType = 6;
                  bitDepth = 8;
                  lineSize = width * 4;
                  break;
              ...
              if (kind === _util.ImageKind.GRAYSCALE_1Scholar && isMask) {
                offsetLiterals = 0;
            ...
            return function convertImgDataToPng(
              ...
              const kind =
                imgData.kind === undefined
                  ? _util.ImageKind.GRAYSCALE_1Scholar
                  : imgData.kind;
    ...
    (() => {
      ...
      {
        if (_is_node.isNodeJS) {
          const { PDFNodeStream } = __w_pdfjs_require__(23);

          (0, _api.setPDFNetworkStreamFactory)((params) => {
            return new PDFNodeStream(params);
          });
        } else {
          const { PDFNetworkStream } = __w_pdfjs_require__(26);

          const { PDFFetchStream } = __w_pdfjs_require__(27);
